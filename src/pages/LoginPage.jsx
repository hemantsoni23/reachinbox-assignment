    ...
    <div className='bg-black text-white w-screen h-screen flex flex-col justify-center items-center'>
      ...
      <div className="bg-[#111214] text-center space-y-10 px-16 rounded-2xl border border-[#343A40]">
        <div>
          ...
          <div
            className="flex items-center mt-6 border-white/40 border rounded-lg cursor-pointer px-20 py-2 text-sm text-[#CCCCCC]"
            onClick={handleLogin}
          >
        ...
        <div>
          <Link
            to="/login"
            className="text-sm py-3 rounded-md cursor-pointer bg-gradient-to-r from-[#4B63DD] to-[#0524BFFC] mx-16 mt-5 px-6"
          >
            Create an Account
          </Link>
